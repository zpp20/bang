import numpy as np
import pytest
from bang.core.pbn.utils.state_printing import convert_to_binary_representation, convert_from_binary_representation
...
def test_array_of_ints():
    ...
    assert np.array_equal([[False, False, True], [True, False, True], [False, True, True], [True, True, True]], output), output
...
def test_example_attractor_output():
    ...
    assert np.array_equal([[[False, False], [True, False]], [[False, True], [True, True]]], output), output
