...
SCP_PBN = PBN(3, [1, 1, 1], [2, 2, 1], [[True, True, True, False], [False, True, False, False], [True, False]], [[0, 1], [0, 1], [1]], [[0], [0], [0]], 0, [3])
SCP_PBN2 = PBN(5, [1, 1, 1,1,1], [2, 2, 1, 3 ,2], 
               ...
               [[0, 1], [0, 1], [1], [1, 2, 4], [3, 4]], [[0], [0], [0], [0], [0]], 0, [3])
SCP_PBN3 = PBN(6, [1, 1, 1,1,1,1], [2, 2, 1, 3 ,2, 2], 
               ...
               [[0, 1], [0, 1], [1], [1, 2, 4], [3, 4], [2, 5]], [[0], [0], [0], [0], [0], [0]], 0, [3])
